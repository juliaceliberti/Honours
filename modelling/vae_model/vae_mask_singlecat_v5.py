...
class VAE(tf.keras.Model):
    ...
    def train_step(self, data):
        ...
        with tf.GradientTape() as tape:
            ...
            total_loss = reconstruction_loss + (1.2 * kl_loss)  # weight KL Loss
...
plt.suptitle(
    "VAE Training and Validation Losses (1.2KL & mask = {})".format(section_name)
)
plt.tight_layout(rect=[0, 0, 1, 0.95])

plt.savefig("vae_loss_plot_{}_10_v5.png".format(section_name))
...
plt.suptitle(
    "VAE Training and Validation Losses (1.2KL & mask = {}) - Log Scale".format(
        section_name
    )
)
plt.tight_layout(rect=[0, 0, 1, 0.95])

plt.savefig("vae_loss_plot_{}_10_v5_log.png".format(section_name))
