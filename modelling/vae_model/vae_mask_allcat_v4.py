...
### Model Definition
# Custom VAE Model with Metric Tracking
# https://asokraju.medium.com/part-1-variational-autoencoders-introduction-and-implementation-1ceb47a75cb5
...
plt.suptitle("VAE Training and Validation Losses (Random Masking)")
plt.tight_layout(rect=[0, 0, 1, 0.95])

plt.savefig("vae_loss_plot_allcat_300_v4.png")
...
plt.suptitle("VAE Training and Validation Losses (Random Masking) - Log Scale")
plt.tight_layout(rect=[0, 0, 1, 0.95])

plt.savefig("vae_loss_plot_allcat_300_v4_log.png")
