...
axs[1].legend()
axs[1].set_title("Whole Reconstruction Loss")
...
plt.savefig("vae_whole_loss_plot_{}_50_v4.png".format(section_name))
...
axs_log[1].legend()
axs_log[1].set_title("Whole Reconstruction Loss (Log Scale)")
...
plt.savefig("vae_whole_loss_plot_{}_50_v7_log.png".format(section_name))
