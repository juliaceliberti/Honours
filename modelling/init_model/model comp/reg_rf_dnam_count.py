...
def predict_dna_methylation():
    ...
    plt.xlabel("Actual Counts")
    plt.ylabel("Predicted Counts")
    plt.title("RF Actual vs Predicted DNA Methylation Counts")

    # Save the plot
    plt.savefig("rf_actual_vs_predicted_dnam_counts_org.png")
    ...
    # Save the plot
    plt.savefig("rf_actual_vs_predicted_dnam_counts_log.png")
    ...
    # Save the plot
    plt.savefig("rf_actual_vs_predicted_dnam_counts_sqrt.png")
