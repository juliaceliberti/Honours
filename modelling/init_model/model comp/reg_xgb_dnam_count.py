...
def predict_dna_methylation():
    ...
    # Save the plot
    plt.savefig("xgb_actual_vs_predicted_dnam_counts_org.png")
    ...
    # Save the plot
    plt.savefig("xgb_actual_vs_predicted_dnam_counts_log.png")
    ...
    # Save the plot
    plt.savefig("xgb_actual_vs_predicted_dnam_counts_sqrt.png")
