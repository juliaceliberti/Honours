### XGB regression to predict Histone count (across 4000 bases) on K9 or K27, using the other histone mod (not set to target), gene expression and DNAm as features
...
plt.title("XBG Actual vs Predicted {} Counts".format(histone))

# Save the plot
plt.savefig("xgb_actual_vs_predicted_{}_counts.png".format(histone))
