...
X = np.concatenate(
    (dnam_features, h3k27me3_features, X_expression), axis=1
)  # Shape (58780, 8001)

# Set H3K9me3 as target - altering y to become a count of 1s in each 4000 length array
...
plt.ylabel("Loss")
plt.legend()
plt.savefig("mlp_loss_k9_counts.png")
