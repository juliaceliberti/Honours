...
# concat features to make 1D (for X: DNAm, K9 and expression)
X = np.concatenate(
    (dnam_features, h3k9me3_features, rna_expression.reshape(-1, 1)), axis=1
)
y = h3k27me3_features  # y: H3K27me3 histone mods
...
pos_weight = 4  # Adjust this based on your class imbalance
...
plt.title("Training and Validation Loss Over Epochs (MLP predicting H3K27me3)")
plt.xlabel("Epochs")
plt.ylabel("Loss")
plt.legend()
plt.savefig("mlp_K27_error_v1.png")
